...
| **TC-02** | Data Sync Audit Logs | `PASS` | 1.2 ms | Found 15 audit entries. Last sync: 2026-09-01 07:23:53 |
| **TC-03** | Executive Dashboard KPIs & Trends | `PASS` | 3.8 ms | Revenue: $70,379.30, Orders: 32, Trend points: 8 |
| **TC-04** | Shipment & Fulfillment Overview | `PASS` | 1.2 ms | Delivered: 1, Not Yet Shipped: 29, Recent: 8 |
| **TC-05** | Sales Summary Grouping (Day/Month) | `PASS` | 1.6 ms | Days: 8, Months: 5 |
| **TC-06** | Period Orders & Level-3 Line Items | `PASS` | 1.6 ms | Orders count: 10, Item 1: Apple MacBook Pro ($3600) |
| **TC-07** | Customer Segmentation & Date Bounds | `PASS` | 1.8 ms | All-time customers: 7, May 2026 active: 1 |
| **TC-08** | Customer Order History & Hierarchy | `PASS` | 1.6 ms | Customer #1 orders: 27, Payment: N/A, Shipping: Standard |
| **TC-09** | Dual Pagination & REST Endpoint Consistency | `PASS` | 832.2 ms | REST endpoint returned valid response (HTTP 200) |
| **TC-10** | URL Hash Routing & Public Bundle Consistency | `PASS` | 210.6 ms | Public Production Asset HTTP Code: 200 (Status 200 OK) |
| **TC-11** | Low Stock Inventory Alerts | `PASS` | 0.7 ms | Found 1 low stock items (threshold <= 10) |
| **TC-12** | CSV Report Export into Nextcloud Files | `PASS` | 196.2 ms | Generated: /NopCommerce_Analytics/Reports/sales_summary_day_20260901_092812.csv |
| **TC-13** | Webhooks Receiver Signature Check | `PASS` | 220.0 ms | HMAC-SHA256 signature verification enforced |
| **TC-14** | Nextcloud info.xsd Schema Compliance | `PASS` | 418.8 ms | Official Nextcloud info.xsd schema validation: 100% VALID |
